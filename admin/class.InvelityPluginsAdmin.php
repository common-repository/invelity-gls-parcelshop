...
class InvelityPluginsAdmin
{
    ...
    public function __construct($launcher)
    {
        ...
        if (is_admin()) {
            ...
            add_action('plugin_action_links_' . plugin_basename(__FILE__), [$this, 'invelityActionLinks']);
        }
...
//            set_transient('invelity-plugins-ad', $response, 300);/*5 min*/
    ...
    public function loadMainAdminAssets()
    {
        ...
        wp_register_style('invelity-plugins-main-admin-css', plugin_dir_url(__FILE__). 'css/invelity-plugins-main-admin.css', array(), '1.0.0');
    ...
    private function generateDownloadedPluginHtml($pluginName, $pluginRemoteData)
    {
        ...
        <div class="item">
            <div class="plugin-list-item-container">
                <div class="header">
                    <div class="logo"><img
                                src="<?= plugins_url() ?>/<?= explode('/', $pluginRemoteData->wp_url)[0] ?>/assets/images/logo.svg"
                                alt=""></div>
                    <div class="title"><?= $pluginName ?></div>
                </div>
                <div class="body">
